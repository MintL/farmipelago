...
export const mats = {
  ...
  grassCrop: new THREE.MeshStandardMaterial({ color: 0x62a84a, roughness: .94 }),
  cutGrass: new THREE.MeshStandardMaterial({ color: 0x8fae54, roughness: .98 }),
  bale: new THREE.MeshStandardMaterial({ color: 0xd1ae52, roughness: .96 }),
  baleBand: new THREE.MeshStandardMaterial({ color: 0x6f8b45, roughness: .9 }),
