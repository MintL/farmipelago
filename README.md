...
- persistent uniform-speed 10-minute day/night cycle with extended daytime, shorter bright dawn/dusk, a layered atmospheric backdrop composed behind and beneath the floating islands, art-directed sun and moon bloom, a brief high-visibility full-moon night, animated celestial shadows, precomputed local surface lighting from static lanterns, dynamic vehicle headlights, and a Debug time-of-day scrubber
