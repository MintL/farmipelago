...
import { createSeederAsset, createSprayerAsset, createMowerDeckAsset, createTrailerAsset, createBalerAsset, createLiquidTankAsset, createFrontAsset } from './refined-tools.js';
...
export function createRearToolAsset(type) {
  const factories = { plough: createPloughAsset, seeder: createSeederAsset, sprayer: createSprayerAsset,
    ...
    trailer: () => createTrailerAsset().group, 'liquid-tank': () => createLiquidTankAsset().group };
