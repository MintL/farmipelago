...
export const mats = {
  ...
  tractor: new THREE.MeshStandardMaterial({ color: 0xe65b32, roughness: 0.68 }),
  tractorDark: new THREE.MeshStandardMaterial({ color: 0xa73526, roughness: 0.74 }),
  tractorAccent: new THREE.MeshStandardMaterial({ color: 0xffc94d, roughness: 0.55, metalness: 0.04 }),
  tractorCream: new THREE.MeshStandardMaterial({ color: 0xfff1c5, roughness: 0.74 }),
  cab: new THREE.MeshStandardMaterial({ color: 0x7ec9cf, roughness: 0.22, metalness: 0.15, transparent: true, opacity: 0.76 }),
  tire: new THREE.MeshStandardMaterial({ color: 0x26302e, roughness: 0.96 }),
  hub: new THREE.MeshStandardMaterial({ color: 0xffd56a, roughness: 0.52, metalness: 0.12 }),
